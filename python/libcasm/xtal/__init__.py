...
from ._methods import (
    StructureAtomInfo,
    cartesian_to_miller_direction,
    cartesian_to_miller_plane,
    combine_structures,
    filter_structure_by_atom_info,
    is_hexagonal_or_trigonal,
    make_canonical,
    ...
    make_within,
    miller_bravais_to_miller_direction,
    miller_bravais_to_miller_plane,
    miller_direction_to_cartesian,
    miller_plane_to_cartesian,
    miller_to_miller_bravais_direction,
    miller_to_miller_bravais_plane,
    scale_columns_to_int_if_possible,
    scale_to_int,
